...
class Registry(Ethereum):
    ...
    def __get_certificate(self, certificate_id):
        ...
        time_of_start_of_production_period = certificate_data[4]
        time_of_stop_of_production_period = certificate_data[5]
        time_of_destruction = certificate_data[6]
        redeemed = "No"
        if certificate_data[7]:
            redeemed = "Yes"
        certificate = {
            "id": certificate_data[0],
            "generating_object": certificate_data[1],
            "energy_type": certificate_data[2],
